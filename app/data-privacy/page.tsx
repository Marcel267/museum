  ...
  return (
      <>
        <div className='text-center max-w-2xl mx-auto'>
          ...
          <br/>
          <h2 className='text-2xl font-bold my-2'>4. Umgang mit Kontaktdaten</h2>
          <p>
          ...
          <br/>
          <h2 className='text-2xl font-bold my-2'>5. Cookies</h2>
          <p>
          ...
          <br/>
          <h2 className='text-2xl font-bold my-2'>6. Ihre Rechte</h2>
          <ul className='list-disc ml-8'>
